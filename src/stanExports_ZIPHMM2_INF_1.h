...
namespace model_ZIPHMM2_INF_1_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ZIPHMM2_INF_1");
    reader.add_event(59, 57, "end", "model_ZIPHMM2_INF_1");
    return reader;
}

#include <stan_meta_header.hpp>
 class model_ZIPHMM2_INF_1 : public prob_grad {
private:
    int N;
    vector<int> y;
    int m;
public:
    model_ZIPHMM2_INF_1(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ZIPHMM2_INF_1_namespace::model_ZIPHMM2_INF_1";
        ...
        try {
            ...
            validate_non_negative_index("lambda_or", "m", m);
            num_params_r__ += m;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("lambda_or")))
            throw std::runtime_error("variable lambda_or missing");
        vals_r__ = context__.vals_r("lambda_or");
        pos__ = 0U;
        validate_non_negative_index("lambda_or", "m", m);
        context__.validate_dims("initialization", "lambda_or", "vector_d", context__.to_vec(m));
        vector_d lambda_or(static_cast<Eigen::VectorXd::Index>(m));
        for (int j1__ = 0U; j1__ < m; ++j1__)
            lambda_or(j1__) = vals_r__[pos__++];
        try {
            writer__.positive_ordered_unconstrain(lambda_or);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable lambda_or: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  lambda_or;
            (void) lambda_or;  // dummy to suppress unused var warning
            if (jacobian__)
                lambda_or = in__.positive_ordered_constrain(m,lp__);
            else
                lambda_or = in__.positive_ordered_constrain(m);
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  lambda(static_cast<Eigen::VectorXd::Index>(m));
            ...
            stan::model::assign(lambda, 
                        ...
                        get_base1(lambda_or,2,"lambda_or",1), 
                        "assigning variable lambda");
            current_statement_begin__ = 20;
            stan::model::assign(lambda, 
                        stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list()), 
                        get_base1(lambda_or,1,"lambda_or",1), 
                        "assigning variable lambda");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_ZIPHMM2_INF_1_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector_d start_pos = in__.simplex_constrain(m);
        double theta = in__.scalar_lub_constrain(0,1);
        vector_d lambda_or = in__.positive_ordered_constrain(m);
        ...
        vars__.push_back(theta);
            for (int k_0__ = 0; k_0__ < m; ++k_0__) {
            vars__.push_back(lambda_or[k_0__]);
            }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= m; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "lambda_or" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
...
typedef model_ZIPHMM2_INF_1_namespace::model_ZIPHMM2_INF_1 stan_model;
