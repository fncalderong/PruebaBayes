...
namespace model_ZIPHMM_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ZIPHMM");
    reader.add_event(50, 48, "end", "model_ZIPHMM");
    return reader;
}

#include <stan_meta_header.hpp>
 class model_ZIPHMM : public prob_grad {
private:
    int N;
    vector<int> y;
    int m;
public:
    model_ZIPHMM(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ZIPHMM_namespace::model_ZIPHMM";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_ZIPHMM_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_ZIPHMM_namespace::model_ZIPHMM stan_model;
